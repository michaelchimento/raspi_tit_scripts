...
with picamera.PiCamera() as camera:
    ...
    camera.annotate_text = "{}".format("Hanja's Magic Pi")
    ...
    try:
        ...
        PAGE="<html><head><title>Greti Live Stream</title></head><body><h1></h1><img src=\"stream.mjpg\" width=\"{}\" height=\"{}\" /></body></html>".format(frame_width, frame_height)
        address = ('', 8000)
